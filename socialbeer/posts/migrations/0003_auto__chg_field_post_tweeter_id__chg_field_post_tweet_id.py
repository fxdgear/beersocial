...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.tweeter_id'
        db.alter_column('posts_post', 'tweeter_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Post.tweet_id'
        db.alter_column('posts_post', 'tweet_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.tweeter_id'
        db.alter_column('posts_post', 'tweeter_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Post.tweet_id'
        db.alter_column('posts_post', 'tweet_id', self.gf('django.db.models.fields.IntegerField')(null=True))
