...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.live'
        db.add_column('posts_post', 'live', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Post.status'
        db.add_column('posts_post', 'status', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Post.live'
        db.delete_column('posts_post', 'live')
