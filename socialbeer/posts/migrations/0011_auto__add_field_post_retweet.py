...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.retweet'
        db.add_column('posts_post', 'retweet', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.retweet'
        db.delete_column('posts_post', 'retweet')
    ...
    models = {
        ...
        'posts.post': {
            ...
            'parent_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['posts.Post']", 'null': 'True', 'blank': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'retweet': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'retweets': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'retweets_rel_+'", 'null': 'True', 'to': "orm['posts.Post']"}),
