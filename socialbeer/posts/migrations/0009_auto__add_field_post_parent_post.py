...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('posts_post', 'parent_post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Post'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.parent_post'
        db.delete_column('posts_post', 'parent_post_id')
